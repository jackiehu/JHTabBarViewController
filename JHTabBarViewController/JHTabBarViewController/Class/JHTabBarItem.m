...
@interface JHTabBarItem ()

@property (nonatomic, weak) JHTabBarBadge *tabBarBadge;
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        JHTabBarBadge *tabBarBadge = [[JHTabBarBadge alloc] init];
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"NotificationTabBarItemChanged" object:nil];
